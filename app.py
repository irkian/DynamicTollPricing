...
# # Log the encoder classes to verify
# st.write("Direction encoder classes:", encoders['direction'].classes_)
# st.write("Start Point encoder classes:", encoders['start_point'].classes_)
# st.write("End Point encoder classes:", encoders['end_point'].classes_)
